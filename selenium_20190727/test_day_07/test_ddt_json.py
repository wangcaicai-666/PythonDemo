...
class TestBaidu(unittest.TestCase):
    ...
    #参数化读取 json 文件
    @file_data('/Users/yaomingxi/Desktop/test_ddt/ddt_data_file.json')
    def test_search_04_json(self,search_key):
    ...
    '''
    #参数化读取 yaml 文件
    @file_data('/Users/yaomingxi/Desktop/test_ddt/test_ddt_file.yaml')
    def test_search_05_yaml(self,case):
        search_key = case[0]["search_key"]
        print("第组组测试用例：",search_key)
        self.baidu_search(search_key)
        sleep(0.8)
        self.assertEqual(self.dr.title,search_key+"_百度搜索")
